...
QUICK_ACCESS_CONCURRENT_DOWNLOADS = int(os.getenv("QUICK_ACCESS_CONCURRENT_DOWNLOADS", "80"))
    ...
    for d in rows or []:
        try:
            ...
            seen.add(cid); clean.append({
                ...
                "username":str(d.get("username", "")),"added_by":str(d.get("added_by", "")),"added_at":str(d.get("added_at", datetime.now(timezone.utc).isoformat()))
            })
...
def _upsert_destination(chat, added_by=None):
    ...
    if ctype not in {"group","supergroup","channel"}: return
    rows=_destinations(); cid=int(chat.id)
    existing=next((x for x in rows if int(x.get("chat_id",0))==cid),None)
    data={"chat_id":cid,"type":ctype,"title":getattr(chat,"title","") or "","username":getattr(chat,"username","") or "","added_by":str(added_by or (existing or {}).get("added_by", "")),"added_at":(existing or {}).get("added_at",datetime.now(timezone.utc).isoformat())}
...
MAIN_LABELS = {
 "en":{"balance":"💰 BALANCE","withdraw":"💸 WITHDRAWAL","ref":"👥 REFERRAL","id":"🆔 GET ID","premium":"💎 PREMIUM","music":"🎵 MUSIC","profile":"👤 Profile","topup":"💳 ADD BALANCE","history":"📜 HISTORY","lang":"🌐 CHANGE LANGUAGE","trial":"🎁 1 DAY FREE TRIAL","customer":"☎️ CUSTOMER","ai":"🤖CUSTOMER AI","search":"🔎 Search Song","currency":"💱 CHANGE CURRENCY"},
 "so":{"balance":"💰 HARAAGA","withdraw":"💸 BIXID","ref":"👥 CASUUMAAD","id":"🆔 ID","premium":"💎 PREMIUM","music":"🎵 MUSIC","profile":"👤 PROFILE","topup":"💳 LACAG KU DAR","history":"📜 TAARIIKH","lang":"🌐 BEDEL LUQAD","trial":"🎁 1 MAALIN Tijaabo","customer":"☎️ MACMIILKA","ai":"🤖 CAWIMAAD AI","search":"🔎 RAADI HEES","currency":"💱 BEDEL LACAG"},
 "am":{"balance":"💰 ሂሳብ","withdraw":"💸 ማውጣት","ref":"👥 ሪፈራል","id":"🆔 ID","premium":"💎 PREMIUM","music":"🎵 MUSIC","profile":"👤 መገለጫ","topup":"💳 ገንዘብ ጨምር","history":"📜 ታሪክ","lang":"🌐 ቋንቋ ቀይር","trial":"🎁 1 ቀን ሙከራ","customer":"☎️ ድጋፍ","ai":"🤖 AI","search":"🔎 ዘፈን ፈልግ","currency":"💱 ምንዛሬ ቀይር"},
 "om":{"balance":"💰 HINDEEN","withdraw":"💸 BAASI","ref":"👥 REFERRAL","id":"🆔 ID","premium":"💎 PREMIUM","music":"🎵 MUSIC","profile":"👤 PROFILE","topup":"💳 MAALLQA DABALI","history":"📜 SEENSA","lang":"🌐 AFAAN JIJJIIRI","trial":"🎁 YAALI 1 GUYYAA","customer":"☎️ DEEGARSA","ai":"🤖 AI","search":"🔎 SIRBA BARBAADI","currency":"💱 MAALLQA JIJJIIRI"},
 "ar":{"balance":"💰 الرصيد","withdraw":"💸 سحب","ref":"👥 إحالة","id":"🆔 المعرف","premium":"💎 بريميوم","music":"🎵 موسيقى","profile":"👤 الملف الشخصي","topup":"💳 إضافة رصيد","history":"📜 السجل","lang":"🌐 تغيير اللغة","trial":"🎁 تجربة مجانية يوم واحد","customer":"☎️ الدعم","ai":"🤖 دعم AI","search":"🔎 بحث عن أغنية","currency":"💱 تغيير العملة"},
 "fr":{"balance":"💰 SOLDE","withdraw":"💸 RETRAIT","ref":"👥 PARRAINAGE","id":"🆔 ID","premium":"💎 PREMIUM","music":"🎵 MUSIQUE","profile":"👤 PROFIL","topup":"💳 AJOUTER","history":"📜 HISTORIQUE","lang":"🌐 CHANGER LANGUE","trial":"🎁 ESSAI 1 JOUR","customer":"☎️ SUPPORT","ai":"🤖 SUPPORT AI","search":"🔎 RECHERCHER UNE CHANSON","currency":"💱 CHANGER DEVISE"},
 "es":{"balance":"💰 SALDO","withdraw":"💸 RETIRAR","ref":"👥 REFERIDOS","id":"🆔 ID","premium":"💎 PREMIUM","music":"🎵 MÚSICA","profile":"👤 PERFIL","topup":"💳 AÑADIR SALDO","history":"📜 HISTORIAL","lang":"🌐 CAMBIAR IDIOMA","trial":"🎁 PRUEBA 1 DÍA","customer":"☎️ SOPORTE","ai":"🤖 SOPORTE AI","search":"🔎 BUSCAR CANCIÓN","currency":"💱 CAMBIAR MONEDA"},
 "de":{"balance":"💰 GUTHABEN","withdraw":"💸 AUSZAHLUNG","ref":"👥 EMPFEHLUNG","id":"🆔 ID","premium":"💎 PREMIUM","music":"🎵 MUSIK","profile":"👤 PROFIL","topup":"💳 GUTHABEN AUFLADEN","history":"📜 VERLAUF","lang":"🌐 SPRACHE ÄNDERN","trial":"🎁 1 TAG TEST","customer":"☎️ SUPPORT","ai":"🤖 AI SUPPORT","search":"🔎 SONG SUCHEN","currency":"💱 WÄHRUNG ÄNDERN"},
 "pt":{"balance":"💰 SALDO","withdraw":"💸 SAQUE","ref":"👥 INDICAÇÕES","id":"🆔 ID","premium":"💎 PREMIUM","music":"🎵 MÚSICA","profile":"👤 PERFIL","topup":"💳 ADICIONAR SALDO","history":"📜 HISTÓRICO","lang":"🌐 MUDAR IDIOMA","trial":"🎁 TESTE 1 DIA","customer":"☎️ SUPORTE","ai":"🤖 SUPORTE AI","search":"🔎 PESQUISAR MÚSICA","currency":"💱 ALTERAR MOEDA"},
 "tr":{"balance":"💰 BAKİYE","withdraw":"💸 ÇEKİM","ref":"👥 REFERANS","id":"🆔 ID","premium":"💎 PREMIUM","music":"🎵 MÜZİK","profile":"👤 PROFİL","topup":"💳 BAKİYE EKLE","history":"📜 GEÇMİŞ","lang":"🌐 DİLİ DEĞİŞTİR","trial":"🎁 1 GÜN DENEME","customer":"☎️ DESTEK","ai":"🤖 AI DESTEK","search":"🔎 ŞARKI ARA","currency":"💱 PARA BİRİMİNİ DEĞİŞTİR"},
 "hi":{"balance":"💰 बैलेंस","withdraw":"💸 निकासी","ref":"👥 रेफरल","id":"🆔 ID","premium":"💎 प्रीमियम","music":"🎵 म्यूज़िक","profile":"👤 प्रोफ़ाइल","topup":"💳 बैलेंस जोड़ें","history":"📜 इतिहास","lang":"🌐 भाषा बदलें","trial":"🎁 1 दिन ट्रायल","customer":"☎️ सहायता","ai":"🤖 AI सहायता","search":"🔎 गाना खोजें","currency":"💱 मुद्रा बदलें"},
 "id":{"balance":"💰 SALDO","withdraw":"💸 PENARIKAN","ref":"👥 REFERAL","id":"🆔 ID","premium":"💎 PREMIUM","music":"🎵 MUSIK","profile":"👤 PROFIL","topup":"💳 TAMBAH SALDO","history":"📜 RIWAYAT","lang":"🌐 GANTI BAHASA","trial":"🎁 UJI COBA 1 HARI","customer":"☎️ BANTUAN","ai":"🤖 BANTUAN AI","search":"🔎 CARI LAGU","currency":"💱 GANTI MATA UANG"},
 "ja":{"balance":"💰 残高","withdraw":"💸 出金","ref":"👥 紹介","id":"🆔 ID","premium":"💎 プレミアム","music":"🎵 音楽","profile":"👤 プロフィール","topup":"💳 残高追加","history":"📜 履歴","lang":"🌐 言語変更","trial":"🎁 1日無料トライアル","customer":"☎️ サポート","ai":"🤖 AIサポート","search":"🔎 曲を検索","currency":"💱 通貨を変更"},
 "ko":{"balance":"💰 잔액","withdraw":"💸 출금","ref":"👥 추천","id":"🆔 ID","premium":"💎 프리미엄","music":"🎵 음악","profile":"👤 프로필","topup":"💳 잔액 충전","history":"📜 기록","lang":"🌐 언어 변경","trial":"🎁 1일 무료 체험","customer":"☎️ 고객지원","ai":"🤖 AI 지원","search":"🔎 노래 검색","currency":"💱 통화 변경"},
 "zh":{"balance":"💰 余额","withdraw":"💸 提现","ref":"👥 邀请","id":"🆔 ID","premium":"💎 高级版","music":"🎵 音乐","profile":"👤 个人资料","topup":"💳 充值","history":"📜 历史","lang":"🌐 更换语言","trial":"🎁 1天免费试用","customer":"☎️ 客服","ai":"🤖 AI客服","search":"🔎 搜索歌曲","currency":"💱 更改货币"},
}
...
def admin_menu():
    ...
    kb.add("👥 Add group", "🗑 Remove group")
    kb.add("📢 Add Channel", "🗑 Remove Channel")
    kb.add("🔗 See Reveral link")
    kb.add("📣 Send all")
...
def localized_user_menu(uid):
    ...
    kb.add(d.get("search","🔎 Search Song"))
...
def download_media(chat_id, link, message_id, quality=None):
    ...
    try:
        ...
        if not media and platform != "pinterest" and _cobalt_enabled():
            try:
        ...
        for path in media[:50 if platform=="tiktok" else 20]:
            markup=None
            if _is_video_file(path):
                token=uuid.uuid4().hex[:24]; music_pending[token]={"uid":uid,"link":link,"created":time.time()}; markup=InlineKeyboardMarkup(row_width=2)
                markup.add(InlineKeyboardButton("🎵 MUSIC",callback_data=f"music:{token}"))
                markup.add(InlineKeyboardButton("➕ Add Group",callback_data=f"add_group:{token}"),InlineKeyboardButton("➕ Add Channel",callback_data=f"add_channel:{token}"))
...
def _song_auto_search_should_handle(m):
    ...
    if not text or text.startswith("/") or not get_setting("song_auto_search_enabled",False) or not _song_search_is_open() or is_admin(m.from_user.id): return False
    excluded={
...
@bot.message_handler(func=lambda m: m.text in {d.get("search", "🔎 Search Song") for d in MAIN_LABELS.values()} or m.text == "🔎 Search Song")
...
def convert_link_to_mp3(chat_id, link, status_message_id):
    ...
    try:
        ...
        music_markup=InlineKeyboardMarkup(row_width=2)
        music_markup.add(
            InlineKeyboardButton("➕ Add Group",callback_data=f"add_group:mp3_{uuid.uuid4().hex[:12]}"),
            InlineKeyboardButton("➕ Add Channel",callback_data=f"add_channel:mp3_{uuid.uuid4().hex[:12]}")
        )
        send_action(chat_id, "upload_audio")
        with open(path, "rb") as audio:
            if cover_path and os.path.isfile(cover_path):
...
def _user_destination_rows(uid, dtype=None):
    ...
    for d in _destinations():
        if dtype and dtype not in {str(d.get("type")), "group" if str(d.get("type")) in {"group","supergroup"} else str(d.get("type"))}: continue
        if str(d.get("added_by")) not in {"",str(uid)} and not is_admin(uid): continue
        rows.append(d)
    return rows

def _destination_picker(uid, dtype):
    rows=_user_destination_rows(uid,dtype)
    kb=InlineKeyboardMarkup(row_width=1)
    for d in rows:
        kb.add(InlineKeyboardButton(_destination_label(d),callback_data=f"destpick:{dtype}:{d['chat_id']}"))
    return kb,rows

@bot.callback_query_handler(func=lambda call: call.data.startswith("add_group:"))
def add_group_inline(call):
    uid=str(call.from_user.id); kb,rows=_destination_picker(uid,"group")
    if not rows:
        bot.answer_callback_query(call.id,"No group is connected yet. Add this bot to a group first.",show_alert=True); return
    bot.answer_callback_query(call.id)
    bot.send_message(call.message.chat.id,"👥 <b>Select a group</b>\n\nChoose where you want the MP3/music to be available.",reply_markup=kb,parse_mode="HTML")

@bot.callback_query_handler(func=lambda call: call.data.startswith("add_channel:"))
def add_channel_inline(call):
    uid=str(call.from_user.id); kb,rows=_destination_picker(uid,"channel")
    if not rows:
        bot.answer_callback_query(call.id,"No channel is connected yet. Add this bot as an admin to a channel first.",show_alert=True); return
    bot.answer_callback_query(call.id)
    bot.send_message(call.message.chat.id,"📢 <b>Select a channel</b>\n\nChoose where you want the MP3/music to be available.",reply_markup=kb,parse_mode="HTML")

@bot.callback_query_handler(func=lambda call: call.data.startswith("destpick:"))
def destination_pick(call):
    try:
        _,dtype,cid=call.data.split(":",2); uid=str(call.from_user.id)
        rows=_user_destination_rows(uid,dtype); target=next((x for x in rows if str(x.get("chat_id"))==str(cid)),None)
        if not target:
            bot.answer_callback_query(call.id,"Destination not found.",show_alert=True); return
        bot.answer_callback_query(call.id,"✅ Added")
        name=_destination_label(target)
        bot.send_message(call.message.chat.id, f"✅ <b>{html.escape(name)}</b> is selected.\n\n"
            "<b>How it works:</b>\nWhen you send media or convert a video to MP3, the bot can post it to this connected destination. "
            "The bot must remain a member/admin there.\n\n"
            "🌐 Supported downloads include the enabled platforms in this bot, plus 🎵 MP3 conversion and Song Search.",parse_mode="HTML")
    except Exception as e:
        print("Destination picker error:",repr(e))
...
def bot_chat_membership_update(update):
    try:
        ...
        if new_status in {"member","administrator","creator"}:
            _upsert_destination(chat, update.from_user.id if getattr(update,"from_user",None) else None)
...
def refer_cmd(m):
    ...
    try:
        ...
        promo_text=get_setting("referral_promo_text","Invite friends and earn rewards with VEXDOU BOT!")
        promo_desc=get_setting("referral_promo_description","Share your personal referral link and earn money when eligible users join.")
        promo = (f"🚀 {promo_text}\n\n{promo_desc}\n\n"
                 "🎬 TikTok | ▶️ YouTube | 📘 Facebook | 📸 Instagram | 👻 Snapchat | 📌 Pinterest | 🐦 X/Twitter\n"
                 "🎵 Video to MP3 | 💎 Premium | ⚡ Fast downloads\n\n"
                 f"{link}")
        kb = InlineKeyboardMarkup()
...
@bot.message_handler(func=lambda m: m.text == "🟢 OPEN SONG IN BOT")
...
@bot.message_handler(func=lambda m: m.text == "🔴 CLOSE SONG IN BOT")
...
def admin_auto_song_on(m):
    if not is_admin(m.from_user.id): return
    set_setting("song_auto_search_enabled",True)
    bot.send_message(m.chat.id,"⚡ <b>AUTO SONG SEARCH ON</b>\n\nUsers can type a song/artist directly without pressing Search Song.",parse_mode="HTML",reply_markup=admin_menu())
...
def admin_auto_song_off(m):
    ...
    bot.send_message(m.chat.id,"⛔ <b>AUTO SONG SEARCH OFF</b>\n\nUsers must press 🔎 Search Song first.",parse_mode="HTML",reply_markup=admin_menu())
...
def admin_add_group(m):
    if not is_admin(m.from_user.id): return
    msg=bot.send_message(m.chat.id,"👥 <b>ADD GROUP</b>\n\nAdd this bot to the group first, then send the group's chat ID here.\nExample: <code>-1001234567890</code>",parse_mode="HTML")
    bot.register_next_step_handler(msg,admin_add_group_step)

def admin_add_group_step(m):
    if not is_admin(m.from_user.id): return
    try:
        cid=int((m.text or "").strip()); chat=bot.get_chat(cid); _upsert_destination(chat,m.from_user.id)
        bot.send_message(m.chat.id,f"✅ Group saved: <b>{html.escape(chat.title or str(cid))}</b>",parse_mode="HTML",reply_markup=admin_menu())
    except Exception as e: bot.send_message(m.chat.id,"❌ Could not add group. Make sure the bot is in the group and the ID is correct.")

@bot.message_handler(func=lambda m: m.text == "🗑 Remove group")
def admin_remove_group(m):
    if not is_admin(m.from_user.id): return
    rows=[x for x in _destinations() if x.get("type") in {"group","supergroup"}]
    kb=InlineKeyboardMarkup(row_width=1)
    for d in rows: kb.add(InlineKeyboardButton("🗑 "+_destination_label(d),callback_data=f"admremove_dest:{d['chat_id']}"))
    bot.send_message(m.chat.id,"Select a group to remove:",reply_markup=kb if rows else None)

@bot.message_handler(func=lambda m: m.text == "📢 Add Channel")
def admin_add_channel_new(m):
    if not is_admin(m.from_user.id): return
    msg=bot.send_message(m.chat.id,"📢 <b>ADD CHANNEL</b>\n\nAdd this bot as an administrator to the channel, then send @username or numeric chat ID.",parse_mode="HTML")
    bot.register_next_step_handler(msg,admin_add_channel_new_step)

def admin_add_channel_new_step(m):
    if not is_admin(m.from_user.id): return
    try:
        value=(m.text or "").strip(); chat=bot.get_chat(value); _upsert_destination(chat,m.from_user.id)
        member=bot.get_chat_member(chat.id,bot.get_me().id)
        if member.status not in {"administrator","creator"}:
            _remove_destination(chat.id); raise RuntimeError("bot is not admin")
        bot.send_message(m.chat.id,f"✅ Channel saved: <b>{html.escape(chat.title or value)}</b>",parse_mode="HTML",reply_markup=admin_menu())
    except Exception: bot.send_message(m.chat.id,"❌ Could not add channel. Bot must be an administrator in that channel.")

@bot.message_handler(func=lambda m: m.text == "🗑 Remove Channel")
def admin_remove_channel_new(m):
    if not is_admin(m.from_user.id): return
    rows=[x for x in _destinations() if x.get("type")=="channel"]
    kb=InlineKeyboardMarkup(row_width=1)
    for d in rows: kb.add(InlineKeyboardButton("🗑 "+_destination_label(d),callback_data=f"admremove_dest:{d['chat_id']}"))
    bot.send_message(m.chat.id,"Select a channel to remove:",reply_markup=kb if rows else None)

@bot.callback_query_handler(func=lambda c: c.data.startswith("admremove_dest:"))
def admin_remove_destination_callback(call):
    if not is_admin(call.from_user.id): return
    cid=call.data.split(":",1)[1]; _remove_destination(cid); bot.answer_callback_query(call.id,"✅ Removed"); bot.send_message(call.message.chat.id,"✅ Destination removed.",reply_markup=admin_menu())

@bot.message_handler(func=lambda m: m.text == "📣 Send all")
def admin_send_all(m):
    if not is_admin(m.from_user.id): return
    msg=bot.send_message(m.chat.id,"📣 <b>SEND ALL</b>\n\nSend the text, photo, video, document or audio you want to send to every connected group/channel.",parse_mode="HTML")
    bot.register_next_step_handler(msg,admin_send_all_step)

def admin_send_all_step(m):
    if not is_admin(m.from_user.id): return
    targets=_destinations(); sent=0; failed=0
    for d in targets:
        cid=int(d.get("chat_id"))
        try:
            if m.text: bot.send_message(cid,m.text)
            elif m.photo: bot.send_photo(cid,m.photo[-1].file_id,caption=m.caption or "")
            elif m.video: bot.send_video(cid,m.video.file_id,caption=m.caption or "",supports_streaming=True)
            elif m.document: bot.send_document(cid,m.document.file_id,caption=m.caption or "")
            elif m.audio: bot.send_audio(cid,m.audio.file_id,caption=m.caption or "")
            elif m.voice: bot.send_voice(cid,m.voice.file_id,caption=m.caption or "")
            else: failed+=1; continue
            sent+=1
        except Exception as e:
            failed+=1; print("Send all destination failed:",cid,repr(e))
    bot.send_message(m.chat.id,f"✅ <b>SEND ALL COMPLETE</b>\n\n📤 Sent: <b>{sent}</b>\n❌ Failed: <b>{failed}</b>\n📍 Connected destinations: <b>{len(targets)}</b>",parse_mode="HTML",reply_markup=admin_menu())
...
@bot.message_handler(func=lambda m: m.text == "🔗 See Reveral link")
def admin_referral_link_settings(m):
    if not is_admin(m.from_user.id): return
    current_text=get_setting("referral_promo_text","Invite friends and earn rewards with VEXDOU BOT!")
    current_desc=get_setting("referral_promo_description","Share your personal referral link and earn money when eligible users join.")
    current_amount=referral_reward_amount()
    msg=bot.send_message(m.chat.id,
        f"🔗 <b>REFERRAL LINK SETTINGS</b>\n\nCurrent reward: <b>${current_amount:.4f}</b>\n"
        f"Current text: <code>{html.escape(str(current_text))}</code>\n"
        f"Current description: <code>{html.escape(str(current_desc))}</code>\n\n"
        "Send in this format:\n<code>Text | Amount | Description</code>\n\nExample:\n<code>Invite friends | 1 | Earn $1 for every eligible referral.</code>",parse_mode="HTML")
    bot.register_next_step_handler(msg,admin_referral_link_settings_step)

def admin_referral_link_settings_step(m):
    if not is_admin(m.from_user.id): return
    parts=[x.strip() for x in (m.text or "").split("|",2)]
    if len(parts)!=3:
        bot.send_message(m.chat.id,"❌ Use: Text | Amount | Description"); return
    text,amount_text,desc=parts
    try: amount=float(amount_text)
    except Exception:
        bot.send_message(m.chat.id,"❌ Amount must be a number."); return
    if not text or not desc or amount<0 or amount>100000:
        bot.send_message(m.chat.id,"❌ Invalid referral settings."); return
    set_setting("referral_promo_text",text); set_setting("referral_promo_description",desc); set_setting("referral_reward",round(amount,8))
    bot.send_message(m.chat.id,"✅ Referral text, reward and description updated.",reply_markup=admin_menu())
