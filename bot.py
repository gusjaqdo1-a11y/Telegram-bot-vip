...
def _ai_intent_answer(uid, q, admin=False, lang="en"):
    ...
    if any(x in q for x in ["download","video","tiktok","instagram","facebook","pinterest","snapchat","twitter","x.com"]):
        if lang=="so": return ("📥 <b>DOWNLOADS</b>\n\n"
            ...
            "💎 Premium/Trial: dhammaan 17-ka platform.\n"
            "Haddii link-ku shaqayn waayo, ii soo qor qaladka aad aragtay.")
        return ("📥 <b>DOWNLOADS</b>\n\n"
            "🆓 Free: TikTok, Instagram, Facebook, Pinterest, Snapchat, X/Twitter + YouTube Shorts.\n"
            "💎 Premium/Trial: all 17 supported Premium/Trial platforms.\n"
            "If the link fails, tell me the error you received.")
