...
def _youtube_song_search(query, limit=8):
    ...
    try:
        ...
        # If the query resolves to a real YouTube artist/channel name, keep only
        # that artist's tracks. This prevents queries such as "Central Cee" from
        # returning unrelated videos that merely contain "Central" or "Cee".
        qn=_song_norm(query)
