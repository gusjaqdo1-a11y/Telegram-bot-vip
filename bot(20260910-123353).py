...
def add_group_inline(call):
    ...
    try:
        ...
        bot.send_message(
            call.from_user.id,
            "👥 <b>Add Group</b>\n\n"
            "Tap <b>➕ Add Group</b> below. Telegram will open <b>Select Chat</b>.\n"
            "Choose your group and allow this bot to be an administrator so it can send messages there later.",
            reply_markup=kb,
            parse_mode="HTML"
        )
    except Exception as e:
...
def add_channel_inline(call):
    ...
    try:
        ...
        bot.send_message(
            call.from_user.id,
            "📢 <b>Add Channel</b>\n\n"
            "Tap <b>➕ Add Channel</b> below. Telegram will open <b>Select Chat</b>.\n"
            "Choose your channel and allow this bot to be an administrator with permission to post messages.",
            reply_markup=kb,
            parse_mode="HTML"
        )
    except Exception as e:
...
def refer_cmd(m):
    ...
    try:
        ...
        reward = referral_reward_amount()
        promo = ("🚀 Invite your friends to VEXDOU BOT and earn money!\n\n"
                 f"🎁 You earn ${reward:.2f} for every eligible referral.\n"
        ...
        bot.send_message(
            ...
            f"🔑 <b>Your Referral Code</b>: <code>{html.escape(str(ref))}</code>\n"
    ...
    for uid, u in list(users.items()):
        try:
            ...
            bot.send_message(
                ...
                f"🔑 Your Referral Code: <code>{html.escape(ref)}</code>\n"
